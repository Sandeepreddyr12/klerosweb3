...
export default function Modal() {
    ...
    //   const { info, setInfo } = useState('');
        ...
        function getResult() {
            ...
            if (Data.GameData.gameState === 'finished') {
                if (Data.GameData.won_Recovered_By === 'MatchDrawn') {
                    ...
                    styles.color = Data.GameData.won_Recovered_By === Data.owner ? 'darkGreen' : 'maroon';
                    text = Data.GameData.won_Recovered_By === Data.owner ? 'You Won!' : 'You Lost!';
                }
                ...
                styles.color =
                  Data.GameData.won_Recovered_By === Data.owner
                    ? 'blue'
                    : 'maroon';
                text = Data.GameData.won_Recovered_By === Data.owner ? 'Recovered by You' : 'Recovered by Opponent';
            }
        ...
        function getMove(){
            if(Data.GameData.gameState === 'finished' && Data.GameData.moves[0] !== ''){
                return Data.owner === Data.GameData.player1 ? Data.GameData.moves[0] : Data.GameData.moves[1];
            }
            return '';
        }
            ...
            <div className={styles.modal}>
              <div className={styles.modal__details}>
                ...
                <div className={styles.game__description}>
                  <div>
                    you :- {Data.owner} <span style={{color : 'gold'}} >{getMove()}</span>{' '}
                  </div>
                  <div>
                    rival :- {''}
              ...
              <div className={styles.gameStatus}>
                {(Data?.GameData && !Data.GameData.won_Recovered_By) && (
                  <>
                    {Date.now() > Number(Data.GameData.timer) ? (
                      <>
                        {Data.owner === Data.GameData.player1 ? (
